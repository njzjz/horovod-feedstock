...
if [[ "${target_platform}" == osx-arm64 ]]; then
    export CMAKE_ARGS="${CMAKE_ARGS} -D Tensorflow_OUTPUT=\"2.14.0;${SP_DIR}/tensorflow/include;-L${SP_DIR}/tensorflow -l:libtensorflow_framework.so.2;-I${SP_DIR}/tensorflow/include -DEIGEN_MAX_ALIGN_BYTES=64\""
